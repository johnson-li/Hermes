...
ssh workstation "docker pull johnson163/hermes; sudo docker run -d --privileged=true -e 'roles=consumer' -e 'host=195.148.125.212' --network host johnson163/hermes:latest"
